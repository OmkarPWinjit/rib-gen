			...
			if (genrateInfo.isUseOtherConfig) {
				...
				if (genrateInfo.otherconfig) {
					if (genrateInfo.otherconfig.entityInfo.path) {
						genrateInfo.otherconfig.entityInfo.path = path.relative(moduleFolderPath, genrateInfo.otherconfig.entityInfo.path);
					...
					if (genrateInfo.otherconfig.pEntityInfo.path) {
						genrateInfo.otherconfig.pEntityInfo.path = path.relative(moduleFolderPath, genrateInfo.otherconfig.pEntityInfo.path);
					...
					if (genrateInfo.otherconfig.completeEntityInfo.path) {
						genrateInfo.otherconfig.completeEntityInfo.path = path.relative(moduleFolderPath, genrateInfo.otherconfig.completeEntityInfo.path);
					...
					if (genrateInfo.otherconfig.pCompleteEntityInfo.path) {
						genrateInfo.otherconfig.pCompleteEntityInfo.path = path.relative(moduleFolderPath, genrateInfo.otherconfig.pCompleteEntityInfo.path);
					...
					if (genrateInfo.otherconfig.parentDataServiceInfo.path) {
						genrateInfo.otherconfig.parentDataServiceInfo.path = path.relative(moduleFolderPath, genrateInfo.otherconfig.parentDataServiceInfo.path);
